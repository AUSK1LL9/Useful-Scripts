...
from cis.defaults import *Home Assistant detected that SSL has been set up on your instance, however, no custom external internet URL has been set.
...
class Certool(object):
    ...
    def gen_cis_cert(self, cis_cert_cn, cert_file, privkey_name, dcname):
        ...
        if cis_cert_cn == 'dataencipherment':
